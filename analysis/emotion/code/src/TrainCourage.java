...
public class TrainCourage{
	...
	public Classifier<String,String> ExecuteTraining(Classifier<String,String> bayes){
		...
		WordsCourage.add("i(')*m no(t)* afraid");
		...
		try {
			...
			FileWriter arq = new FileWriter("/home/lucas/Documents/WordsCourage.txt");
